(() => {
  ...
  if (demo) {
    const modes = {
      delete: {
        index: '01', message: 'Давай в 19:00, у нашего кафе ☕',
        event: 'Сообщение удалено', icon: '#i-trash',
        label: 'Алина удалила сообщение',
        saved: 'Давай в 19:00, у нашего кафе ☕',
        note: 'В чате исчезло. У вас — нет.'
      },
      edit: {
        index: '02', message: 'Давай в 20:00, у нашего кафе ☕',
        original: 'Давай в 19:00, у нашего кафе ☕',
        event: 'Сообщение изменено', icon: '#i-edit',
        label: 'Алина изменила сообщение',
        saved: 'Было: в 19:00 → Стало: в 20:00',
        note: 'Изменилось время? Вы заметите.'
      },
      media: {

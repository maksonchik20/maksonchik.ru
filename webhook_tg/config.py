...
START_TEXT = (
    ...
    "• Предупредит о возможной скрытой\n"
    "пересылке кружка: если дата в файле\n"
    "старше отправки более чем на 3 минуты.\n"
    "Работает, когда дата сохранена;\n"
    "это не доказательство пересылки.\n"
...
CONNECTION_REMINDER_TEXT = (
    ...
    "<b>Как подключить:</b>\n"
    "1. Откройте управление профилем:\n"
    "   • iOS: <b>Профиль → Изменить</b>.\n"
    "   • Android: <b>Профиль → Аккаунт</b>.\n"
    "2. Прокрутите список вниз и откройте <b>Автоматизация чатов</b>.\n"
    "3. Введите <b>@who_update_bot</b> и нажмите <b>Добавить</b>.\n\n"
